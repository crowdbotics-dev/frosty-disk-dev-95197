"""
Django settings for frosty_disk_dev_95197 project.
...
ROOT_URLCONF = 'frosty_disk_dev_95197.urls'
...
WSGI_APPLICATION = 'frosty_disk_dev_95197.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_disk_dev_95197 API",
    "DESCRIPTION": "API documentation for frosty_disk_dev_95197 App",
    "VERSION": "v1",
}
